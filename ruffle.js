(()=>{
    ...
    (()=>{
        ...
        let c = null;
        function u() {
            return null !== c && c.buffer === t.memory.buffer || (c = new Uint8Array(t.memory.buffer)),
            c
        }
        function l(e, t) {
        ...
        function g(e, t, n) {
            if (void 0 === n) {
                const n = b.encode(e)
                  , r = t(n.length);
                return u().subarray(r, r + n.length).set(n),
                f = n.length,
                r
            }
            let r = e.length
        ...
        let w = null;
        function h() {
            return null !== w && w.buffer === t.memory.buffer || (w = new Int32Array(t.memory.buffer)),
            w
        }
        function m(e) {
            return null == e
        ...
        let T = null;
        function P(e, n) {
            return (null !== T && T.buffer === t.memory.buffer || (T = new Float32Array(t.memory.buffer)),
        ...
        let N = null;
        function U(e, n) {
            return (null !== N && N.buffer === t.memory.buffer || (N = new Uint8ClampedArray(t.memory.buffer)),
                ...
                var r = g(e, t.__wbindgen_malloc, t.__wbindgen_realloc)
                  ...
                  , o = function(e, n) {
                    const r = n(4 * e.length)
                      , i = (null !== j && j.buffer === t.memory.buffer || (j = new Uint32Array(t.memory.buffer)),
                    j);
        ...
        const W = async function r(o) {
            ...
            s.wbg.__wbindgen_number_get = function(e, n) {
                ...
                (null !== p && p.buffer === t.memory.buffer || (p = new Float64Array(t.memory.buffer)),
                p)[e / 8 + 1] = m(o) ? 0 : o,
                h()[e / 4 + 0] = !m(o)
            }
            ,
            ...
            return null == z && (z = async function(e) {
                return "function" == typeof Array.prototype.reduce && $(Array.prototype.reduce) || Object.defineProperty(Array.prototype, "reduce", {
                    value(...e) {
                        ...
                        for (; o < r; )
                            o in n && (i = t(i, n[o], o, n)),
                            o++;
                        return i
                    }
                }),
                "function" == typeof Window && $(Window) || "function" == typeof window.constructor && $(window.constructor) && (window.Window = window.constructor),
            ...
            if (void 0 !== window.customElements)
                for (; n < 999; ) {
                    ...
                    void 0 === window.customElements.get(r))
                        return window.customElements.define(r, t),
                        Z[e] = {
                            class: t,
                            name: r,
                            internalName: e
        ...
        class ce extends HTMLElement {
            constructor() {
                ...
                this.playButton && this.playButton.addEventListener("click", (()=>this.play())),
                ...
                if (this.isConnected && !this.isUnusedFallbackObject()) {
                    if (!fe(this))
                        try {
                            ...
                            if (r.allowScriptAccess = e.allowScriptAccess,
                            this.showSwfDownload = !0 === r.showSwfDownload,
                            this.options = e,
                            this.hasContextMenu = !1 !== r.contextMenu,
                            r.backgroundColor && (this.container.style.backgroundColor = r.backgroundColor),
                            ...
                            "url"in e) {
                                ...
                                this.instance.load_data(new Uint8Array(e.data), se(e.parameters)))
                        } catch (e) {
            ...
            async downloadSwf() {
                try {
                    if (this.swfUrl) {
                        ...
                        r.href = n,
                        r.download = this.swfUrl.substring(this.swfUrl.lastIndexOf("/") + 1),
            ...
            showContextMenu(e) {
                ...
                for (const e of this.contextMenuItems())
                    if (null === e) {
                        ...
                        !1 !== r ? i.addEventListener("click", n) : i.classList.add("disabled")
                    }
                ...
                this.contextMenuElement.style.left = Math.floor(Math.min(n, i)) + "px",
                this.contextMenuElement.style.top = Math.floor(Math.min(r, o)) + "px"
            }
            hideContextMenu() {
                var e;
            ...
            panic(e) {
                ...
                let a, s, c = `https://github.com/ruffle-rs/ruffle/issues/new?title=${encodeURIComponent(`Error on ${o}`)}&labels=error-report&body=`, u = encodeURIComponent(i);
                switch (r.stackIndex > -1 && String(c + u).length > 8195 && (r[r.stackIndex] = null,
                u = encodeURIComponent(r.join(""))),
                c += u,
                n) {
                case 2:
        ...
        class we extends ce {
            ...
            static isInterdictable(e) {
                ...
                if (fe(e))
                    return !1;
                if (e.getElementsByTagName("ruffle-embed").length > 0)
                    return !1;
                ...
                if (s === "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase())
                    return !Array.from(e.getElementsByTagName("embed")).some(be.isInterdictable);
                if (null != s && "" !== s)
                    return !1;
        ...
        async function Ie(e, t) {
            ...
            if (pe || void 0 === r.documentElement.dataset.ruffleOptout)
                if (pe)
                    ...
                    e.RufflePlayer.config = Object.assign(Object.assign({}, ye), null !== (n = e.RufflePlayer.config) && void 0 !== n ? n : {});
                else if (!e.RufflePlayer) {
                    const t = r.createElement("script");
                    t.setAttribute("src", ve),
                    t.onload = ()=>{
                        e.RufflePlayer = {},
                        e.RufflePlayer.config = ye
                    }
                    ,
        ...
        class Re {
            ...
            static fromSemver(e) {
                ...
                let o = 0
                  ...
                  , s = null
                  , c = null;
                return null != r[1] && (o = parseInt(r[1], 10)),
        ...
        class Te {
            constructor(e) {
                ...
                this.conflict = null,
                null != e && (e instanceof Te ? (this.sources = e.sources,
                ...
                "loading" === document.readyState ? window.addEventListener("DOMContentLoaded", this.init.bind(this)) : window.setTimeout(this.init.bind(this), 0)
            }
            get version() {
                return "0.1.0"
            }
            ...
            static negotiate(e, t, n) {
                let r;
                return r = e instanceof Te ? e : new Te(e),
                void 0 !== t && void 0 !== n && (r.registerSource(t, n),
            ...
            polyfill(e) {
                !function(e) {
                    ...
                    new MutationObserver((function(e) {
                        e.some((e=>e.addedNodes.length > 0)) && (Se(),
                        Ce())
                    }
                    )).observe(document, {
                        childList: !0,
